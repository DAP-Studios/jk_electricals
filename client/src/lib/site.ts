...
export const SITE_TITLE = "JK Electricals Vapi | Industrial Electrical Supplier in Vapi GIDC";
...
export const ROUTES = [
  {
    path: "/",
    title: "JK Electricals Vapi | Industrial Electrical Supplier in Vapi GIDC",
    description:
